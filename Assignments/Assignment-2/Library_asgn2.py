...
def make_diag_non_0(A,B):
    '''
    # Making the Diagonal Elements Non-Zero for LU Decomposition
    ## Parameters
    - A: The matrix A in the equation A.X = B
    - B: The matrix B in the equation A.X = B
    ## Returns
    - A: The matrix A with diagonal elements non-zero
    - B: The Corresponding matrix B
    '''
    flag = 0
    for i in range(len(A)):
        if A[i][i] == 0:
